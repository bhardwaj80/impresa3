...
const SwipperSlide = [
    ...
    { swipperImg: IMAGES.galleryImg1, changeStyle: "mt-5" },
    { swipperImg: IMAGES.galleryImg2, },
    { swipperImg: IMAGES.galleryImg3, changeStyle: "mt-5" },
    { swipperImg: IMAGES.galleryImg4 },
    { swipperImg: IMAGES.galleryImg5, changeStyle: "mt-5" },
    { swipperImg: IMAGES.galleryImg6 },
    { swipperImg: IMAGES.galleryImg1, changeStyle: "mt-5" },
    { swipperImg: IMAGES.galleryImg2 },
    { swipperImg: IMAGES.galleryImg4, changeStyle: "mt-5" },
]
    ...
    return (
        <>
            <div className="page-content bg-white">
                ...
                <CommanBanner mainTitle="Portfolio Detail" parentTitle="Home" pageName="Portfolio Detail" bgImage={IMAGES.video} />
